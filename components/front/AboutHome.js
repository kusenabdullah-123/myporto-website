...
const AboutHome = () => {
  return (
    <section className="pt-36 pb-32 dark:bg-dark" id="about-home">
      <div className="container">
        <div className="flex flex-wrap">
          <div className="mb-10 w-full px-4 lg:w-1/2">
            ...
            <h2 className="mb-5 max-w-md text-3xl font-bold text-dark dark:text-white lg:text-5xl">
              Belajar Menjadi Developer Expert
            </h2>
            <p className="max-w-xl text-base font-medium text-slate-500 lg:text-lg">
              Terus belajar Sampai Mencapai harapan Yang Di Inginkan
            </p>
          </div>
          <div className="w-full px-4 lg:w-1/2">
            ...
            <p className="mb-6 text-base font-medium text-slate-500 lg:text-lg">
              Mari Berteman Dan Sharing Informasi
            </p>
