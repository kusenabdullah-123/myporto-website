...
const EditBlog = ({ blogs, category, url }) => {
  ...
  return (
    <div>
      ...
      {/* Header End */}
      <main>
        <h1 className="text-lg text-center">Edit Blogs</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <label htmlFor="title" className="mb-4 block">
              ...
              <input
                ...
                defaultValue={blogs.metaDescription}
              />
            </label>
            <label htmlFor="title" className="mb-4 block">
              ...
              <input
                ...
                className="block w-full mt-1 p-2 border-b-2 border-slate-400 text-sm focus:outline-none"
                name="metaKeyword"
                defaultValue={blogs.metaKeyword}
              />
            </label>
            <label htmlFor="title" className="mb-4 block">
...
export const getServerSideProps = async ({ req, res, params }) => {
  ...
  const result = await axios.get(`${url}api/blogs/${params.id}`);

  return {
    props: {
      blogs: result.data.data[0],
      url,
